<section id="login-form-container" class="login-form-container">
    ...
    <form-request id="login-form" action="/api/v1/login/?<?= SESSION_RESUME_PARAM ?>=<?= urlencode($_GET[SESSION_RESUME_PARAM] ?? "")?>" method="POST" complete="refresh" autosave="enter" @csrf_attribute();>

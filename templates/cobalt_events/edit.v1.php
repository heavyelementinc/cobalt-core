<hgroup>
    ...
    <action-menu id="more-menu">
        <option method="DELETE" action="/api/v1/cobalt-events/{{!event._id}}" dangerous="true">Delete</option>
    </action-menu>
    <!-- <div id="options">
        <button ><i name="menu"></i></button>
    </div> -->
</hgroup>
<!-- <tab-nav>
    <nav>
                ...
                <fieldset>
                    ...
                    <ul class="list-panel">
                        ...
                        <li>
                            ...
                            <radio-group name="txtJustification" value="{{event.txtJustification}}">
                                <label>
                    ...
                    <ul class="list-panel">
                        ...
                        <li>
                            <label>Included paths <help-span
                                    value="If the user has navigated to a path which matches one of the entries on this list, this event will be considered 'showable'. Leave blank to ignore.\n\If you specify /about and you have a page /about/example, the event will appear on /about/example too. To prevent subpages, end your path with a $ so /about$ or /about/?$">
                                </help-span>
                            </label>

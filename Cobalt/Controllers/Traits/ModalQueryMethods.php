...
trait ModalQueryMethods {
     ...
     */
    public function getParams(Model &$model, array $filterOverride, array $allowedFilters = [], $allowedOptions = [], $defaultOptions = null): array {
        return $this->parseFilterAndOptions($model, $filterOverride, $allowedFilters, $allowedOptions, $defaultOptions);
    }

    public function params(Model &$model, array $defaultFilters = [], $misc = [
        'defaultOptions' => null,
        'allowedFilters' => [],
        'allowedOptions' => [],
    ]) {
        return $this->parseFilterAndOptions($model, $defaultFilters, $misc['allowedFilters'] ?? [], $misc['allowedOptions'] ?? [], $misc['defaultOptions'] ?? []);
    }
     ...
     * @throws Exception 
     */
    final public function parseFilterAndOptions(Model &$manager, array $filterOverride, array $allowedFilters = [], $allowedOptions = [], $defaultOptions = null): array {

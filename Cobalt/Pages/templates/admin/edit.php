<hgroup><h1>{{title}} "<span id="title">{{doc.title}}</span>"</h1>{{!deleted}}<action-menu>{{!delete_option}}</action-menu></hgroup>
...
<style>
    ...
    :where(#main) :where(input, textarea, [__custom-input]) {
        width: 100%;
        box-sizing: border-box;
    }

...
/**
 * To automagically populate this list, run the following command from within 
 * __ENV_ROOT__:
 * `php Cobalt/DataModel/automations/build-directive-list.php`
 *
 ...
 * @property-read ReferenceModel $external_model

        ...
        <fieldset>
            ...
            <ul class="list-panel colors">
                <li>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_branding,branding_increment,branding_rotation', 'name' => "Branding", 'value' => __APP_SETTINGS__['color_branding']]);
                </li>
                <li>
                    <div>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_primary,primary_increment,primary_rotation', 'name' => "Primary", 'value' => __APP_SETTINGS__['color_primary']]);
                </li>
                <li>
                    <div>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_issue,issue_increment,issue_rotation', 'name' => "Issue", 'value' => __APP_SETTINGS__['color_issue']]);
                </li>
                <li>
                    <div>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_neutral,neutral_increment,neutral_rotation', 'name' => "Neutral", 'value' => __APP_SETTINGS__['color_neutral']]);
                </li>
                <li>
                    <div>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_background,background_increment,background_rotation', 'name' => "Background", 'value' => __APP_SETTINGS__['color_background']]);
                </li>
                <li>
                    <div>
                    ...
                    @view("Cobalt/Settings/templates/settings/inputs/reset.php", ['setting' => 'color_font_body', 'name' => "Text Color", 'value' => __APP_SETTINGS__['color_font_body']]);
                </li>

...
<form-request method="{{method}}" action="{{action}}" <?= $newDocAutosave ?>>
    <tab-nav>
        <nav>
            <a href="#basic"><i name="post"></i> Basic Content</a>
            <a href="#images"><i name="image-multiple"></i> Images</a>
        ...
        <div id="basic">
            <ul class='list-panel'>
                ...
                <!-- <li>
                    ...
                    <input-array name="tags" <?= $newDocDisabled ?>>{{!doc.tags.options()}}</input-array>
                </li> -->
            </ul>
        </div>
        <div id="images">
